...
{
    /**
     * Implementation of {@link IConnection}.
    ...
    private static string FORM_URL_ENCODED = "application/x-www-form-urlencoded";
    ...
    public static IConnection Connect(string url)
        ...
        public IConnection url(URL url)
        {
            req.url(url);
            return this;
        }
        ...
        public IConnection followRedirects(boolean followRedirects)
        {
        ...
        public IConnection ignoreHttpErrors(boolean ignoreHttpErrors)
        {
            req.ignoreHttpErrors(ignoreHttpErrors);
            return this;
        }

        public IConnection ignoreContentType(boolean ignoreContentType)
        {
            req.ignoreContentType(ignoreContentType);
            return this;
        }

        public IConnection validateTLSCertificates(boolean value)
        {
        ...
        public IConnection data(string key, string filename, InputStream inputStream)
        {
            req.data(KeyVal.create(key, filename, inputStream));
            return this;
        }

        public IConnection data(Map<string, string> data)
        {
        ...
        public IConnection data(string...keyvals)
        {
        ...
        public IConnection data(Collection<IConnection.KeyVal> data)
        {
            Validate.notNull(data, "Data collection must not be null");
            for (IConnection.KeyVal entry: data)
            {
                req.data(entry);
            }
            return this;
        ...
        public IConnection cookies(Map<string, string> cookies)
        {
        ...
        public IConnection.Response execute() throws IOException
        {
            res = Response.execute(req);
        return res;
        }

        public IConnection.Request request()
        {
            return req;
        }

        public IConnection request(IConnection.Request request)
        {
            req = request;
            return this;
        }

        public IConnection.Response response()
        {
            return res;
        }

        public IConnection response(IConnection.Response response)
        {
            res = response;
            return this;
        }

        public IConnection postDataCharset(string charset)
        {
    ...
    public class Request : HttpConnection.Base<IConnection.Request> implements IConnection.Request {
        private int timeoutMilliseconds;
    private int maxBodySizeBytes;
    private boolean followRedirects;
    private Collection<IConnection.KeyVal> data;
    ...
    private Request()
    {
        ...
        data = new ArrayList<IConnection.KeyVal>();
        method = Method.GET;
    ...
    public IConnection.Request maxBodySize(int bytes)
    {
    ...
    public IConnection.Request followRedirects(boolean followRedirects)
    {
    ...
    public IConnection.Request ignoreHttpErrors(boolean ignoreHttpErrors)
    {
    ...
    public IConnection.Request ignoreContentType(boolean ignoreContentType)
    {
        this.ignoreContentType = ignoreContentType;
        return this;
    }

    public Request data(IConnection.KeyVal keyval)
    {
    ...
    public Collection<IConnection.KeyVal> data()
    {
        return data;
    }
    ...
    public IConnection.Request postDataCharset(string charset)
    {
...
public static class Response extends HttpConnection.Base<IConnection.Response> implements IConnection.Response {
...
private IConnection.Request req;
...
static Response execute(IConnection.Request req) throws IOException
{
            return execute(req, null);
}

static Response execute(IConnection.Request req, Response previousResponse) throws IOException
{
...
private static HttpURLConnection createConnection(IConnection.Request req) throws IOException
{
        ...
        private static synchronized void initUnSecureTSL() throws IOException
{
    ...
    public X509Certificate[] getAcceptedIssuers() {
        ...
        private void setupFromConnection(HttpURLConnection conn, IConnection.Response previousResponse) throws IOException
{
...
private static string setOutputContentType(final IConnection.Request req)
{
    // multipart mode, for files. add the header if we see something with an inputstream, and return a non-null boundary
    boolean needsMulti = false;
    for (IConnection.KeyVal keyVal : req.data())
    {
...
private static void writePost(final IConnection.Request req, final OutputStream outputStream, final string bound) throws IOException
{
    final Collection<IConnection.KeyVal> data = req.data();
    final BufferedWriter w = new BufferedWriter(new OutputStreamWriter(outputStream, DataUtil.defaultCharset));

            if (bound != null) {
        // boundary will be set if we're in multipart mode
        for (IConnection.KeyVal keyVal : data)
        {
            w.write("--");
            w.write(bound);
            w.write("\r\n");
...
private static string getRequestCookieString(IConnection.Request req)
{
...
private static void serialiseRequestUrl(IConnection.Request req) throws IOException
{
    URL in = req.url();
    ...
    public static class KeyVal implements IConnection.KeyVal
{
    private string key;
